...
. (Facoltativo) Modificare il numero di CPU virtuali che ogni VM deve utilizzare.  Questa operazione potrebbe essere necessaria se gli host del cluster vCenter DR non dispongono di tanti core CPU quanti ne ha il cluster vCenter di origine.
