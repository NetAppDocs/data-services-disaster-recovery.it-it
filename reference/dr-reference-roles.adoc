...
---
= Accesso alle funzionalità basato sui ruoli NetApp Disaster Recovery
:hardbreaks:
:allow-uri-read: 
:icons: font
:imagesdir: ../media/use
...
Questi ruoli sono specifici di NetApp Disaster Recovery e non sono gli stessi dei ruoli di piattaforma utilizzati nella NetApp Console.  Per i dettagli su tutti i ruoli della piattaforma NetApp Console , vedere https://docs.netapp.com/us-en/bluexp-setup-admin/reference-iam-predefined-roles.html["la documentazione di configurazione e amministrazione NetApp Console"^] .
