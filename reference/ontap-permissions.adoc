...
[role="lead"]
Configura le autorizzazioni ONTAP necessarie affinché NetApp Disaster Recovery possa funzionare correttamente.
...
NetApp Disaster Recovery richiede le seguenti autorizzazioni ONTAP:
...
Per aggiungere autorizzazioni in ONTAP, crea un ruolo con i privilegi richiesti e assegnalo a un utente. Puoi completare questa operazione in ONTAP con System Manager o la ONTAP CLI.
