...
summary: 'NetApp fornisce supporto per la Console in vari modi. Sono disponibili ampie opzioni di auto-assistenza gratuite 24 ore su 24, 7 giorni su 7, come articoli della knowledge base (KB) e un forum della community. La registrazione al supporto include il supporto tecnico remoto tramite ticketing web.' 
---
= Ottieni assistenza con NetApp Disaster Recovery
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
