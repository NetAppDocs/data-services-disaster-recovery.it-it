...
+
** Se non hai ancora aggiunto un agente NetApp Console , dovrai aggiungerne uno. Per aggiungere l'agente, fare riferimento a https://docs.netapp.com/us-en/console-setup-admin/concept-connectors.html["Scopri di più sugli agenti della console"^] .
