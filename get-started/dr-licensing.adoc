...
*Aggiungi la licenza alla NetApp Console** Dopo aver acquistato la licenza NetApp Disaster Recovery da un rappresentante commerciale NetApp , puoi gestirla nella console.
