...
+
È possibile visualizzare i dettagli dell'abbonamento nella pagina di abbonamento NetApp Console . link:https://docs.netapp.com/us-en/bluexp-digital-wallet/task-homepage.html["Scopri di più sulla gestione degli abbonamenti con la NetApp Console"^] .
...
https://docs.netapp.com/us-en/bluexp-digital-wallet/task-manage-data-services-licenses.html["Scopri come aggiungere licenze con la NetApp Console"^] .
...
TIP: Questo messaggio appare anche nella NetApp Console e in https://docs.netapp.com/us-en/bluexp-setup-admin/task-monitor-cm-operations.html#monitoring-operations-status-using-the-notification-center["Notifiche"] .

https://docs.netapp.com/us-en/bluexp-digital-wallet/task-manage-data-services-licenses.html["Scopri come aggiornare le licenze con la NetApp Console"^] .
