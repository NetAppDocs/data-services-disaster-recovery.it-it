...
summary: NetApp Disaster Recovery è un servizio di disaster recovery basato sul cloud che automatizza i flussi di lavoro di disaster recovery. Con NetApp Disaster Recovery, puoi replicare i carichi di lavoro VMware on-premises che utilizzano storage ONTAP in un data center VMware software-defined nei cloud pubblici come sito di disaster recovery utilizzando NetApp cloud storage. 
---
...
Ora puoi accedere alla documentazione Swagger direttamente da Disaster Recovery. In Disaster Recovery, seleziona **Impostazioni** quindi **Documentazione API**. Dovresti essere in modalità privata o in incognito per accedere a link:https://api.bluexp.netapp.com/v1/services/draas/api/api-doc/draas["il collegamento"^].
...
Quando crei un piano di replica, la nuova impostazione predefinita è mantenere la struttura delle cartelle della VM. Se la destinazione di recovery non ha la gerarchia di cartelle originale, Disaster Recovery la crea. Puoi deselezionare questa opzione per ignorare la gerarchia di cartelle originale.
...
La NetApp Console, basata sulla piattaforma BlueXP migliorata e ristrutturata, offre una gestione centralizzata dello storage NetApp e dei NetApp Data Services in ambienti on-premises e cloud di livello enterprise, fornendo insight in real-time, flussi di lavoro più rapidi e un'amministrazione semplificata, altamente sicura e conforme.
...
Per i dettagli, vederelink:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-disaster-rec-roles.html["Ruoli utente e autorizzazioni in NetApp Disaster Recovery"] .

https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["Scopri i ruoli di accesso per tutti i servizi"^].
...
Per dettagli sullo skipping della protezione, consulta  https://docs.netapp.com/us-en/data-services-disaster-recovery/use/failover.html["Eseguire il failover delle applicazioni su un sito remoto"].
...
Per i dettagli, fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/sites-add.html["Aggiungi siti server vCenter"] .
...
Questa release di NetApp Disaster Recovery offre supporto per ASA r2 per VM e datastore su storage VMFS. Su un sistema ASA r2, il software ONTAP supporta le funzionalità SAN essenziali, rimuovendo le funzionalità non supportate negli ambienti SAN.
...
Quando crei un piano di replica, ora puoi aggiungere un prefisso e un suffisso ai nomi delle VM nel sito di disaster recovery. Questo ti permette di usare un nome più descrittivo per le VM nel piano.
...
Fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/monitor-jobs.html["Monitorare i lavori"] .
...
Fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/manage.html["Gestire i piani"] .
...
Fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/manage.html["Gestire le VM"] .
...
Fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/get-started/dr-prerequisites.html["Prerequisiti NetApp Disaster Recovery"] .
...
https://docs.netapp.com/us-en/data-services-disaster-recovery/get-started/dr-intro.html["Scopri di più su NetApp Disaster Recovery"].
...
Per i dettagli sulla configurazione delle licenze per NetApp Disaster Recovery, fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/get-started/dr-licensing.html["Impostare la licenza"] .

Per i dettagli sulla gestione delle licenze per *tutti* i servizi dati NetApp Console , fare riferimento a https://docs.netapp.com/us-en/console-licenses-subscriptions/task-manage-data-services-licenses.html["Gestisci le licenze per tutti i servizi dati NetApp Console"^] .
...
Per i dettagli, fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/drplan-create.html["Creare il piano di replicazione"] .
...
Per i dettagli, fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/failover.html["Failover su un sito remoto"] .
...
Fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/dashboard-view.html["Visualizza lo stato di salute dei tuoi piani di disaster recovery nella Dashboard"] .
...
+
Fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/drplan-create.html["Creare un piano di replicazione"] .
...
+
Fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/manage.html["Gestire le risorse"] .
...
La pagina Job Monitor ora include un'opzione Aggiorna, che consente di ottenere uno stato aggiornato delle operazioni. Fare riferimento a https://docs.netapp.com/us-en/data-services-disaster-recovery/use/monitor-jobs.html["Monitorare i lavori di ripristino di emergenza"] .
...
link:https://docs.netapp.com/us-en/data-services-disaster-recovery/get-started/dr-intro.html["Scopri di più su NetApp Disaster Recovery"].
