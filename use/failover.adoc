...
Durante un test di failover, Disaster Recovery crea temporaneamente macchine virtuali. Risaster Recovery mappa un datastore temporaneo che supporta il volume FlexClone sugli host ESXi.
