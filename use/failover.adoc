...
Durante un test di failover, Disaster Recovery crea temporaneamente macchine virtuali. Disaster Recovery mappa un datastore temporaneo che supporta il FlexClone volume sugli host ESXi.
