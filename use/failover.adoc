...
. Facoltativamente, selezionare *Forza failover* se si desidera che il failover venga eseguito anche se viene rilevato un errore che normalmente ne impedirebbe il verificarsi.
