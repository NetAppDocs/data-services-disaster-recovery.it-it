...
Prima di eseguire un failover reale, è possibile effettuare un test per verificarne la predisposizione. I carichi di lavoro rimangono online durante il processo di test.
...
+
Quindi immettere “Test failover” e selezionare *Test fail over*.
...
IMPORTANT: Se il piano di replica include un datastore vuoto, è necessario prima rimuovere il datastore vuoto dal piano oppure utilizzare l'opzione **Force failover**, che ignora i datastore vuoti.
