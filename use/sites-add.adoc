...
+
Se è la prima volta che utilizzi NetApp Disaster recovery, devi aggiungere le informazioni di vCenter. Se hai già aggiunto le informazioni di vCenter, visualizzi la dashboard.
