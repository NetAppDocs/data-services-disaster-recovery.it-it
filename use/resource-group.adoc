...
[role="lead"]
Dopo aver aggiunto i siti vCenter, puoi creare gruppi di risorse per raggruppare VM o datastore come un'unica unità. I gruppi di risorse consentono di organizzare un insieme di VM dipendenti in gruppi logici che soddisfano i tuoi requisiti. Ad esempio, potresti raggruppare le VM associate a un'applicazione oppure potresti raggruppare applicazioni che hanno livelli simili. Un altro esempio è che i gruppi potrebbero contenere ordini di avvio ritardati che possono essere eseguiti al momento del ripristino.
...
I gruppi di risorse consentono di combinare VM o datastore in un'unica unità.
