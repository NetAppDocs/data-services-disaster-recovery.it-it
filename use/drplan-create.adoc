...
. *Utilizza snapshot su richiesta per il failover del test pianificato*: per acquisire un nuovo snapshot prima di avviare il failover del test automatico, seleziona questa casella.
